...
| НОМЕР ИСР | НАЗВАНИЕ ЗАДАЧИ                          | 1-я неделя  | 2-я неделя | 3-я неделя | 4-я неделя | 5-я неделя |
|-----------|------------------------------------------|-------------|------------|------------|------------|------------|
| 1.1       | Разработать макеты сайта и согласовать   | * * *       |            |            |            |            |
| 1.2       | Сверстать страницы                      | * * *       |            |            |            |            |
| 1.3       | Настроить веб-серверы и деплой          |             | * *        |            |            |            |
| 1.4       | Подготовить архитектуру приложения      |             | * *        |            |            |            |
| 1.5       | Спроектировать базу данных              |             | * *        |            |            |            |
| 1.6       | Реализовать регистрацию                 |             |            | * * *      |            |            |
| 1.7       | Реализовать авторизацию                 |             |            | * * *      |            |            |
| 1.8       | Реализовать верификацию аккаунта        |             |            | * * *      |            |            |
| 1.9       | Реализовать главную страницу            |             |            |            | * *        |            |
| 1.10      | Реализовать страницу банк портфолио     |             |            |            | * * *      |            |
| 1.11      | Реализовать страницу гостя              |             |            |            |            | * * *      |
| 1.12      | Реализовать страницу личного кабинета  |             |            |            |            | * * *      |
| 2.1       | Публикация проекта на тестовом сервере |             |            |            |            | * *        |
